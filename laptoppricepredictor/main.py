...
import pickle
import numpy as np
import sklearn  # Importing sklearn in case it's needed for any additional tasks

st.title("Laptop Price Predictor")

# Load the pre-trained model and data
pipe = pickle.load(open('pipe.pkl', 'rb'))  # Your pre-trained model
df = pickle.load(open('data.pkl', 'rb'))   # The dataset
